  ...
  return (
    ...
    >
      <motion.div
        variants={fadeTop}
        {...motionStep}
        className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 custom-container mx-auto px-5 md:px-0"
      >
        ...
        <div className="text-center md:text-left space-y-4 text-white">
          ...
          <p className="text-base md:text-xl text-gray-400 max-w-md md:max-w-lg mx-auto md:mx-0 leading-tight">
          ...
          <div className="flex justify-center  md:justify-start mt-6">
            <a href={'/resume_Md_Rakib_Mia_Resume.pdf'} download={true}>
              <Button className="cursor-pointer gap-2 bg-cyan-600 text-white dark:bg-white dark:text-cyan-600 hover:bg-cyan-700 dark:hover:bg-gray-200 transition-all px-4 py-2 rounded">
